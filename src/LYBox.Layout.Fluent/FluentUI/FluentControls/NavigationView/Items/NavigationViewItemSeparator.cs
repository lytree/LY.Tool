    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        if (splitView != null)
        {
            _splitViewRevokers = new FACompositeDisposable(
                splitView.GetPropertyChangedObservable(SplitView.IsPaneOpenProperty).FASubscribe(args => OnSplitViewPropertyChanged(args)),
                splitView.GetPropertyChangedObservable(SplitView.DisplayModeProperty).FASubscribe(args => OnSplitViewPropertyChanged(args)));
